    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        switch (columnData[0]) {
            case TableNameConst.T_3RDAPI_PA_OVERDUE_CLASSIFICATION:
                ...
                outValue.put(new Text(ColumnHeadConstant.T_3RDAPI_PA_OVERDUE_CLASSIFICATION + "__" + columnData[8] + "__" + columnData[9] + "__f_record_nums"), new Text(columnData[3]));
                outValue.put(new Text(ColumnHeadConstant.T_3RDAPI_PA_OVERDUE_CLASSIFICATION + "__" + columnData[8] + "__" + columnData[9] + "__f_org_nums"), new Text(columnData[4]));
                outValue.put(new Text(ColumnHeadConstant.T_3RDAPI_PA_OVERDUE_CLASSIFICATION + "__" + columnData[8] + "__" + columnData[9] + "__f_max_amount"), new Text(columnData[5]));
                outValue.put(new Text(ColumnHeadConstant.T_3RDAPI_PA_OVERDUE_CLASSIFICATION + "__" + columnData[8] + "__" + columnData[9] + "__f_longest_days"), new Text(columnData[6]));
                break;
            case TableNameConst.T_3RDAPI_PA_OVERDUE_RECORD:
                ...
                outValue.put(new Text(ColumnHeadConstant.T_3RDAPI_PA_OVERDUE_RECORD + "f_match_type"), new Text(columnData[2]));
                break;
            default:
                outKey.set("N");
